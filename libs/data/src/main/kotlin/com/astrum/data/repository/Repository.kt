...
suspend fun <T : Any, ID : Any> Repository<T, ID>.updateByIdOrFail(
    id: ID,
...
suspend fun <T : Any, ID : Any> Repository<T, ID>.updateOrFail(
    entity: T,
    patch: SuspendPatch<T>
): T {
    return update(entity, patch) ?: throw EmptyResultDataAccessException(1)
...
suspend fun <T : Any, ID : Any> Repository<T, ID>.update(
    entity: T,
    patch: (entity: T) -> Unit
): T? {
...
suspend fun <T : Any, ID : Any> Repository<T, ID>.updateById(
    id: ID,
    patch: (entity: T) -> Unit
): T? {
